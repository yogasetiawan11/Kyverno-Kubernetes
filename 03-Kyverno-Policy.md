...
kind: ClusterPolicy  # this will apply to all ns => use Policy only if you want to create a policy for particular ns
metadata:
  ...
  annotations:
    ...
    policies.kyverno.io/description: >-
      this is an error massage, you can write an error massage here
spec:
  ...
  - name: validate-resources
    match:
      ...
      - resources:
          ...
          - Pod
    validate:
      message: "CPU and memory resource requests and memory limits are required for containers creatuion."
      pattern:
        spec:
          containers:
          - resources:
